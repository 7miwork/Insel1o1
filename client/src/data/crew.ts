...
export const CREW_MEMBERS: CrewMember[] = [
  {
    ...
    // Updated to match shared i18n keys used in the main app
    roleKey: "about.crew.captain.title",
    descriptionKey: "about.crew.captain.description",
    icon: "Crown",
  ...
  },
  {
    ...
    roleKey: "about.crew.navigator.title",
    descriptionKey: "about.crew.navigator.description",
    icon: "Compass",
  ...
  },
  {
    ...
    roleKey: "about.crew.pobbie.title",
    descriptionKey: "about.crew.pobbie.description",
    icon: "Code",
